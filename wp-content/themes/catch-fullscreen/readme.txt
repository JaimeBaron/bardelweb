...
Catch Fullscreen is a one page WordPress theme that comes with incredible features and captivating design. The theme is extremely easy to customize.
...
For more information about Catch Fullscreen please go to https://catchthemes.com/themes/catch-fullscreen/

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Catch Fullscreen in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Go to https://catchthemes.com/theme-instructions/catch-fullscreen/ for a guide on how to customize this theme.
...
You can check our Theme Instructions at https://catchthemes.com/themes/catch-fullscreen in the Theme Instructions Tab.

= Where can I find theme demo? =

You can check our Theme Demo at https://catchthemes.com/demo/catch-fullscreen/
...
= 2.0.4 (Released: February 02, 2019) =
...
= 1.0.2 (Released: September 14, 2018) =
...
Catch Fullscreen WordPress Theme, Copyright 2012-2019 Catchthemes.com
...
* JS Files
	...
	FullPage 3.0.2,  Copyright (C) 2018, Alvaro Trigo
	http://alvarotrigo.com/fullPage
	License: GPLv3 for open source use only
 	https://github.com/alvarotrigo/fullPage.js
	 	* Scrolloverflow.js (iScroll) is an integration with FullPage
...
* Images
	...
	Bundled header image and Screenshot Image
	https://pixabay.com/en/ballerina-ballet-dancers-dancing-1850109/

	Portfolio Section
	https://pixabay.com/en/architecture-modern-building-facade-1048092/
